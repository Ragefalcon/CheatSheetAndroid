...
object MyColor {
    val VeryLightBrown = Color(0xFFe9e5de)
    val LightBrown = Color(0xFFdad3c8)
    val WarmLightBrown = Color(0xFFd0bea2)
    val DarkGrayBrown = Color(0xFF595051)
    val AlmostBlack = Color(0xFF262525)
    val LightGreen = Color(0xFFaebc9b)
    val WarmGreen = Color(0xFF3f6900)
    val GrayGreen = Color(0xFF808660)
    val LightYellow = Color(0xFFecd048)
    val WarmDarkYellow = Color(0xFFc38b14)
    val GrayText = Color(0xFF8d8d8c)
}
